                ...
                <div className="flex items-center justify-between pb-6 border-b-[2px] border-gray-200">
                    <div className="flex flex-row gap-3">
                        <div className="flex items-center w-12 h-12 border border-gray-200 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50" className="w-6 h-6 m-auto">
                        ...
                        <div className="flex flex-col">
                            <div className="font-semibold text-md"> Samsung Browser - Android </div>
                            <div className="font-medium text-sm text-gray-500 dark:text-gray-200">
                                Thailand, Changwat Phetchabun
                            </div>
                        </div>
                    </div>
                    <div className="flex gap-4 items-center">
                        <Button size="sm" variant="outlined" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>Remove</Button>
                    </div>
                </div>
            </div>
        </div>
